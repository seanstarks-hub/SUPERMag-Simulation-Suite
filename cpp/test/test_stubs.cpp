...
int main() {
    ...
    assert(supermag_usadel_solve(0,0,0,0,0,0,0,SUPERMAG_USADEL_NONLINEAR,nullptr,0,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
    assert(supermag_eilenberger_solve(0,0,0,0,0,0,nullptr,0,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
    assert(supermag_bdg_solve(0,0,0,0,0,nullptr,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
    assert(supermag_gl_minimize(0,0,0,0,0,0,SUPERMAG_GL_SCALAR,0,nullptr,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
    assert(supermag_josephson_cpr(0,0,0,0,0,0,0,nullptr,nullptr,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
    assert(supermag_triplet_solve(0,nullptr,nullptr,nullptr,nullptr,0,0,0,0,SUPERMAG_TRIPLET_DIFFUSIVE,0,nullptr,nullptr) == SUPERMAG_ERR_NULL_PTR);
