// Proximity effect kernels: coth (0-phase) and tanh (π-phase)
...
// coth kernel: K = q * coth(q * d_F)  — 0-junction, semi-infinite/thick-F
// tanh kernel: K = q * tanh(q * d_F)  — π-junction, thin-F/reflected
